    ...
    <section id="relume" className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container">
        <div className="mb-12 w-full md:mb-18 lg:mb-20">
          <h1 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">Client Testimonials</h1>
          <p className="md:text-md">Fortis Security provided exceptional service and support.</p>
        </div>
        <div className="grid grid-cols-1 gap-y-12 md:grid-cols-2 md:gap-x-8 lg:gap-16">
          <div className="flex h-full max-w-lg flex-col items-start justify-start text-left">
            ...
            <blockquote className="text-md font-bold leading-[1.4] md:text-xl">
              "The professionalism and dedication of Fortis Security were outstanding. They ensured our event ran
              smoothly and safely."
            </blockquote>
          ...
          <div className="flex h-full max-w-lg flex-col items-start justify-start text-left">
            ...
            <blockquote className="text-md font-bold leading-[1.4] md:text-xl">
              "Thanks to Fortis Security, we felt completely secure. Their team was professional and attentive to all
              our needs."
            </blockquote>
            <div className="mt-6 flex w-full flex-col gap-3 md:mt-8 md:w-auto md:flex-row md:items-center md:gap-5">
              <div>
